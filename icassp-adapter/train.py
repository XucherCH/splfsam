...
from sam import getmodel
from model.train_utils import train_one_epoch, evaluate, get_params_groups, create_lr_scheduler
...
def parse_args():
    ...
    parser.add_argument('--resume', default='model_best.pth', help='resume from checkpoint')
