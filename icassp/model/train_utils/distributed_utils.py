...
class F1Score(object):
    ...
    def update(self, pred: torch.Tensor, gt: torch.Tensor):
        ...
        pp = resize_pred[torch.gt(gt, self.threshold)]  # Corresponds to the foreground region in the prediction map
        nn = resize_pred[torch.le(gt, self.threshold)]  # Corresponds to the background region in the prediction map
